...
@section('content')
    <section class="content-header">
        <h1>
            Thêm - Sản Phẩm
            <small><a href="{{ route('admin.product.index') }}">Danh sách SP</a></small>
        </h1>
    </section>
                    ...
                    <form role="form" action="{{route('admin.product.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control w-50" id="stock" name="stock" value="10">
                            </div>
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="exampleInputFile">Giá gốc (vnđ)</label>
                                        <input type="number" class="form-control" id="price" name="price" value="200000">
                                    </div>
                                </div>
                                <!-- /.col-lg-6 -->
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="sale" name="sale" value="200000">
                                    </div>
                                </div>
                                <!-- /.col-lg-6 -->
                            </div>
